...
class SocialAssistanceController extends Controller implements HasMiddleware
{
    ...
    {
        return [
            new Middleware(PermissionMiddleware::using(['social-assistance-list|social-assistance-create|social-assistance-update|social-assistance-delete']), only: ['index', 'store', 'update', 'destroy']),
