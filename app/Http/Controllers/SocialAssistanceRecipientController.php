...
class SocialAssistanceRecipientController extends Controller implements HasMiddleware
{
    ...
    {
        return [
            new Middleware(PermissionMiddleware::using(['social-assistance-recipient-list|social-assistance-recipient-create|social-assistance-recipient-update|social-assistance-recipient-delete']), only: ['index', 'store', 'update', 'destroy']),
